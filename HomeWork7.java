...
public class HomeWork7 {
    ...
    public static List<String> methodOne(List<String> names) {
        ...
        names.stream().filter(n -> n.contains("King")).forEach(n -> newList.add(n));
        return newList;
    }
    ...
    public static List<String> methodTwo(List<String> names) {
        ...
        newList1.stream().distinct().forEach(n->newList2.add(n));
        return newList2;
    }
    ...
    public static List<String> methodThree(List<String> names) {
        ArrayList<String> newList1 = new ArrayList<>();
        names.stream().filter(n -> n.startsWith("L")).map(n-> new StringBuilder(n)).forEach(n-> newList1.add(String.valueOf(n.replace(n.indexOf(" "),n.length(),""))));
        ArrayList<String> newList2 = new ArrayList<>();
        newList1.stream().distinct().forEach(n-> newList2.add(n));
        return newList2;
    }
    ...
    public static List<String> methodFour(List<String> names) {
        ...
        names.stream().map(n-> new StringBuilder(n)).forEach(n-> newList1.add(String.valueOf(n.replace(0,n.indexOf(" ")+1,""))));
        ArrayList<String> newList2 = new ArrayList<>();
        newList1.stream().distinct().filter(n->n.startsWith("W")).sorted().forEach(n-> newList2.add(n));
        return newList2;
    }
    ...
    public static List<String> methodSeven(List<String> names) {
        LinkedList<String> newList1 = new LinkedList<>();
        names.stream().map(n-> new StringBuilder(n)).filter(n->(n.substring(n.indexOf(" ")+1,n.indexOf(" ")+2)).equals("K") || (n.substring(n.indexOf(" ")+1,n.indexOf(" ")+2)).equals("S")).forEach(n->newList1.add(String.valueOf(n.replace(n.indexOf(" ")+2,n.length(),"."))));
        LinkedList<String> newList2 = new LinkedList<>();
        newList1.stream().sorted().distinct().forEach(n->newList2.add(n));
        return newList2;
    }
